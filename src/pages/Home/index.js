...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, FlatList, DrawerLayoutAndroidBase } from 'react-native'
    ...
    return(
        <SafeAreaView style = { styles.container } >
            <View style={styles.header}>
                <Animatable.Text style={styles.name} animation={"fadeInLeft"} delay={200}>Blog</Animatable.Text>
